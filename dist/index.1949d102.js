...
})({"8Hhlf":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e8e237331949d102";
"use strict";
...
var _loginTs = require("./pages/welcome-page/login/login.ts");
var _signupTs = require("./pages/welcome-page/signup/signup.ts");
var _selectPageTs = require("./pages/select-page/select-page.ts");
var _chatPageTs = require("./pages/chat-page/chat-page.ts");
var _router = require("./router");
(function() {
    (0, _state.state).init();
})();

},{"./state":"1Yeju","./pages/welcome-page/login/login.ts":"jNYod","./pages/welcome-page/signup/signup.ts":"ehvGQ","./pages/select-page/select-page.ts":"5aNK9","./pages/chat-page/chat-page.ts":"ak9mo","./router":"4QFWt"}],"1Yeju":[function(require,module,exports) {
...
const state = {
    ...
    listeners: [],
    init () {
        if (sessionStorage.length === 0) console.log("No hay data guardada en el navegador");
        else {
    ...
    listenToRoom () {
        const currentState = this.getState();
        const messagesRef = (0, _database.ref)((0, _rtdb.rtdb), "/rooms/" + currentState.realTimeDataBaseId + "/messages");
        (0, _database.onValue)(messagesRef, (snap)=>{
    ...
    setEmailNameAndPassword (email, password, nombre) {
        const currentState = this.getState();
    ...
    pushMessage (message) {
        const currentState = this.getState();
        if (currentState.username) fetch(API_BASE_URL + "/messages/" + currentState.realTimeDataBaseId, {
            method: "post",
            headers: {
        ...
        else console.error("No hay nombre de usuario.");
    },
    login (callback) {
        const currentState = this.getState();
        if (currentState.email) fetch(API_BASE_URL + "/login", {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
        ...
        else console.error("No hay un email registrado.");
    },
    signup (callback) {
        const currentState = this.getState();
        if (currentState.email && currentState.name && currentState.password) fetch(API_BASE_URL + "/signup", {
            method: "post",
            headers: {
                "content-type": "application/json"
            },
        ...
        else console.error("Complet\xe1 bien el formulario porfa.");
    },
    newRoom (callback) {
        const currentState = this.getState();
        ...
        else console.error("Para crear una nueva sala, ten\xe9s que haber iniciado sesi\xf3n.");
    },
    accessToRoom (callback) {
        const currentState = this.getState();
        if (currentState.userId) fetch(API_BASE_URL + "/rooms/" + currentState.roomId + "?userId=" + currentState.userId).then((res)=>{
            return res.json();
        }).then((data)=>{
        ...
        else console.error("Fijate que por ah\xed escribiste mal la id de la room.");
    },
    subscribe (callback) {
...
},{"./rtdb":"6XypP","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"6XypP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"firebase/app":"aM3Fo","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"aM3Fo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"3AcPV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/component":"bi1VB","@firebase/logger":"fZmft","@firebase/util":"ePiK6","idb":"kozAz","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"bi1VB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"ePiK6","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"ePiK6":[function(require,module,exports) {
/**
 * @license
...
var global = arguments[3];
var process = require("af74ba3d954b7afd");
const CONSTANTS = {
    /**
...
},{"af74ba3d954b7afd":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"d5jf4":[function(require,module,exports) {
...
},{}],"j2HOu":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"kozAz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./wrap-idb-value.js":"lS54k","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"lS54k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"SJ4UY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
parcelHelpers.exportAll(_database, exports);

},{"@firebase/database":"cQryS","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"cQryS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _util = require("@firebase/util");
var _logger = require("@firebase/logger");
var process = require("aad0f1e6341af0f2");
...
},{"aad0f1e6341af0f2":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"jNYod":[function(require,module,exports) {
...
class LoginPage extends HTMLElement {
    connectedCallback() {
        ...
        this.querySelector(".form").addEventListener("submit", (e)=>{
            ...
            (0, _state.state).setEmailNameAndPassword(target.email.value, target.password.value);
            (0, _state.state).login(()=>{
                if ((0, _state.state).getState().userId) (0, _router.Router).go("/select");
            });
        });
    }
    render() {
        ...
        const inputEl = document.querySelector("#form-password");
...
},{"@vaadin/router":"kVZrF","../../../state":"1Yeju"}],"kVZrF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j2HOu"}],"ehvGQ":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../../state");
class SignupPage extends HTMLElement {
    connectedCallback() {
        ...
        this.querySelector(".form").addEventListener("submit", (e)=>{
            e.preventDefault();
            const target = e.target;
            (0, _state.state).setEmailNameAndPassword(target.email.value, target.password.value, target.nombre.value);
...
},{"@vaadin/router":"kVZrF","../../../state":"1Yeju"}],"5aNK9":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
        ...
        selectEl.addEventListener("change", (ev)=>{
            ...
            if (target.value === "unir") {
                ...
                this.querySelector(".form").addEventListener("submit", (e)=>{
                    e.preventDefault();
                    const target = e.target;
                    (0, _state.state).setUserName(target.usuario.value);
                    (0, _state.state).setRoomId(target.roomid.value);
...
},{"@vaadin/router":"kVZrF","../../state":"1Yeju"}],"ak9mo":[function(require,module,exports) {
var _state = require("../../state");
class ChatPage extends HTMLElement {
    messages = [];
    connectedCallback() {
        (0, _state.state).listenToRoom();
        const currentState = (0, _state.state).getState();
        ...
        (0, _state.state).subscribe(()=>{
            ...
            if (messagesSectionEl) messagesSectionEl.scrollTop = messagesSectionEl.scrollHeight;
        });
        this.render();
    }
    addListeners() {
        this.querySelector(".send-message__form").addEventListener("submit", (e)=>{
            e.preventDefault();
            const target = e.target;
            (0, _state.state).pushMessage(target["send-message"].value);
        });
    }
    render() {
        this.innerHTML = `
            <div class="header">
                <p class="header__roomid">Id de la sala: ${(0, _state.state).getState().roomId}</p>
            </div>
            <section class="messages-section">
                ${this.messages.map((m)=>{
            if (m.from === (0, _state.state).getState().username) return `
...
},{"../../state":"1Yeju"}],"4QFWt":[function(require,module,exports) {
var _router = require("@vaadin/router");
...
},{"@vaadin/router":"kVZrF"}]},["8Hhlf","h7u1C"], "h7u1C", "parcelRequire94c2")

//# sourceMappingURL=index.1949d102.js.map
